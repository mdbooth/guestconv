...
RHEL_60_64_EFI_Test = test_helper.make_image_test(
    'RHEL_60_64_EFI_Test',
    RHEL60_64_EFI_IMG,
    u'/dev/VolGroup/lv_root',
    {
        u'graphics': [],
        u'network': [u'e1000', u'rtl8139'],
        u'block': [u'ide-hd', u'scsi-hd'],
    ...
    make_grub_tests(u'/dev/VolGroup/lv_root',
                    [u'/boot/vmlinuz-2.6.32-71.el6.x86_64']),
    make_xml_test(u'''
<guestconv>
  <root name="/dev/VolGroup/lv_root">
    <info>
      <arch>x86_64</arch>
  ...
  <boot>
    <loader disk="sda" name="grub-efi" type="EFI">
      <replacement name="grub-bios" type="BIOS"/>
    </loader>
  </boot>
</guestconv>
    ''')
...
all_tests = unittest.TestSuite((
    ...
    unittest.makeSuite(RHEL_60_64_EFI_Test)
))
